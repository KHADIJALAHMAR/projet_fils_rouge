    ...
    <div class="d-flex" id="wrapper">
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle second-text fw-bold" href="#" id="navbarDropdown"
                                ...
                                <i class="fas fa-user me-2"></i> khadija LAHMAR
                            </a>
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="nav-link  text-muted" class="dropdown-item"  href="<?php echo URLROOT; ?>/ControllerCompte/logout">logout</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
		...
		<table class="table bg-white rounded shadow-sm  table-hover">
            ...
            <?php foreach ($data['pharmacists'] as $pharmacist):?>
                    ...
                    <td id="m1">role</td>
                    <td><a href="<?php echo URLROOT;?>/ControllerAdmin/delete_pharmacist/<?= $pharmacist->id_user; ?>"class="btn btn-danger" <span class="glyphicon glyphicon-trash"></span>Delete<a></td>
